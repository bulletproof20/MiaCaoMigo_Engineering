...
| 14–15 | Limitations, future improvements and conclusion | Time constraints, reserved Mod3, animal image support, HR prototypes, planned security/performance work, message of real integration |
...
5. If time allows, mention performance baseline and one planned security test (invalid token or missing permission).
